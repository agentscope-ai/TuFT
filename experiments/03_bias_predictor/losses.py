...
class EvalSummary:
    ...
    def pretty(self) -> str:
        lines = [
            ...
            f"  token  MAE         {self.baseline_token_mae:9.5f}   {self.corrected_token_mae:9.5f}   "  # noqa: E501
            f"{self._impr(self.baseline_token_mae, self.corrected_token_mae)}",
            f"  token  bias        {self.baseline_token_bias:9.5f}   {self.corrected_token_bias:9.5f}   "  # noqa: E501
            f"{self._impr(self.baseline_token_bias, self.corrected_token_bias)}",
            f"  seq    mean_log_is {self.baseline_mean_log_is:9.4f}   {self.corrected_mean_log_is:9.4f}   "  # noqa: E501
            f"{self._impr(abs(self.baseline_mean_log_is), abs(self.corrected_mean_log_is))}",
            f"  seq    med|log_is| {self.baseline_median_abs_log_is:9.4f}   {self.corrected_median_abs_log_is:9.4f}   "  # noqa: E501
