...
_BUILTIN_APIS = {
    ...
    "BookRestaurant": {
        ...
        "example": "BookRestaurant(restaurant='Olive Garden', date='2024-03-20', time='19:00', party_size='4')",
    },
    "SearchHotel": {
    ...
    "BookHotel": {
        ...
        "example": "BookHotel(hotel_name='Hilton', check_in='2024-04-01', check_out='2024-04-03', guest_name='John')",
    },
    "SearchFlight": {
    ...
    "CreateCalendarEvent": {
        ...
        "example": "CreateCalendarEvent(title='Lunch', date='2024-03-20', time='12:00', duration='60')",
    },
}
...
_BUILTIN_SCENARIOS = [
    {
        ...
        "final_answer": "The weather in Beijing tomorrow will be sunny with a temperature of 25°C and humidity of 40%.",
    },
    {
        "user_query": "I need to book a table for 4 at an Italian restaurant in San Francisco for this Friday at 7pm.",
        ...
        "mock_responses": {
            "SearchRestaurant": "Found restaurants: 1. Trattoria Roma (4.5 stars), 2. Pasta House (4.2 stars), 3. Italian Corner (4.0 stars).",
            "BookRestaurant": "Reservation confirmed at Trattoria Roma for 4 guests on Friday at 19:00. Confirmation #TR2024.",
        },
        "final_answer": "I've booked a table for 4 at Trattoria Roma for this Friday at 7pm. Your confirmation number is TR2024.",
    },
    {
        "user_query": "Find me a flight from New York to London on May 1st and book it for Alice Johnson.",
        ...
        "mock_responses": {
            "SearchFlight": "Available flights: 1. BA178 (departs 10:30, $850), 2. UA901 (departs 18:00, $920), 3. AA100 (departs 22:00, $780).",
            "BookFlight": "Flight BA178 booked for Alice Johnson on 2024-05-01. E-ticket: BA178-AJ-2024.",
        },
        "final_answer": "I've booked flight BA178 for Alice Johnson from New York to London on May 1st. Your e-ticket number is BA178-AJ-2024.",
    },
    {
        "user_query": "Search for hotels in Shanghai from April 1-3 and book the Hilton for me. My name is John Smith.",
        ...
        "mock_responses": {
            "SearchHotel": "Available hotels: 1. Hilton Shanghai ($200/night, 4.5 stars), 2. Marriott ($180/night, 4.3 stars), 3. Holiday Inn ($120/night, 4.0 stars).",
            "BookHotel": "Reservation confirmed at Hilton Shanghai for John Smith, April 1-3. Confirmation: HS-20240401-JS.",
        },
        "final_answer": "I've booked the Hilton Shanghai for you from April 1-3. Confirmation number: HS-20240401-JS.",
    },
    {
    ...
    },
    {
        ...
        "mock_responses": {
            "GetNews": "Top stories: 1. 'New AI Model Breaks Records' (TechDaily), 2. 'AI in Healthcare: 2024 Outlook' (MedNews), 3. 'OpenAI Announces GPT-5' (Reuters)."
        },
        "final_answer": "Here are the latest AI news: 1. New AI Model Breaks Records, 2. AI in Healthcare: 2024 Outlook, 3. OpenAI Announces GPT-5.",
    },
    {
        ...
        "mock_responses": {
            "CalculateRoute": "Route: Central Park → FDR Drive → Van Wyck Expressway → JFK. Distance: 18.5 miles, estimated time: 35-55 minutes."
        },
        "final_answer": "From Central Park to JFK Airport is about 18.5 miles via FDR Drive and Van Wyck Expressway, taking approximately 35-55 minutes.",
    },
    {
        "user_query": "Create a calendar event for lunch with Sarah on March 20th at noon for 1 hour.",
        ...
        "mock_responses": {
            "CreateCalendarEvent": "Event 'Lunch with Sarah' created for March 20, 2024 at 12:00 (1 hour)."
        },
        "final_answer": "I've created a calendar event 'Lunch with Sarah' for March 20th at noon, lasting 1 hour.",
    },
    {
        "user_query": "I want to find a hotel in Tokyo for next week, from Monday to Thursday, and also check the weather there on Monday.",
        ...
        "mock_responses": {
            "SearchHotel": "Available: 1. Tokyo Grand Hotel ($150/night), 2. Sakura Inn ($95/night), 3. Imperial Tokyo ($280/night).",
            "GetWeather": "Tokyo next Monday: Partly cloudy, 18°C, 30% chance of rain.",
        },
        "final_answer": "Hotels in Tokyo: Tokyo Grand Hotel ($150/night), Sakura Inn ($95/night), Imperial Tokyo ($280/night). Weather on Monday: partly cloudy, 18°C.",
    },
]
...
class APIBankTask(AgentTask):
    ...
    def step(self, action_text: str, metadata: Dict[str, Any]) -> StepResult:
        ...
        if not match:
            return StepResult(
                observation="Invalid action format. Use: Action: ToolCall[ApiName(params)] or Action: Finish[response]",
                reward=0.0,
                done=False,
    ...
    def _do_tool_call(
        ...
        if not parsed:
            return StepResult(
                observation=f"Failed to parse API call: '{call_str}'. Use format: ApiName(key='value')",
                reward=0.0,
                done=False,
