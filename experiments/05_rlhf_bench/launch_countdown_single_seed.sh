#!/usr/bin/env bash
# Countdown GRPO single-seed benchmark with baseline / predictor / global_mean
set -euo pipefail
...
SEED=42
OUTDIR="./results/bench_countdown_seed${SEED}"
mkdir -p "${OUTDIR}"
echo "===== Countdown Seed ${SEED} -> ${OUTDIR} ====="
...
echo "Countdown single-seed benchmark done."
