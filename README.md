...
| [Open Character Training](https://agentscope-ai.github.io/TuFT/en/latest/user-guide/open-character-training.html) | Distill a written constitution with DPO, then reinforce the learned character through introspection SFT. [Example](examples/open_character_training/) |
| [Custom Losses](https://agentscope-ai.github.io/TuFT/en/latest/user-guide/custom-losses.html) | Client-defined objectives (e.g. composite DPO + NLL) via `forward_backward_custom`, supported on both HF and FSDP backends. |
